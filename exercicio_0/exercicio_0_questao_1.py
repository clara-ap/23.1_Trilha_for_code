# substituir Pyhton por Fython no texto apresentado

texto = '''Python é uma linguagem de programação de alto nível, [5] interpretada \
...
formalmente especificada. O padrão na pratica é a implementação CPython. A \
...
textoModificado = texto.replace('Python', 'Fython')
